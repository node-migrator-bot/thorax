...
(function() {
  var Application, CreateFileModal, LumbarConfig, MainView, Module, ThoraxConfig, editOrCreate, generator, lumbarConfig, mainView, openFile, prefix, saveFile, savedEditor, socket, thoraxConfig;
      ...
      return this.attributes.raw.scripts.forEach(function(script) {
        ...
        if (item.src) {
          ...
          if (type) {
            ...
            if (type === 'views') {
              console.log(_this.attributes.name);
  ...
  editOrCreate = function(event) {
    ...
    if (createType) {
      ...
      return console.log('edit routes');
    } else {
  ...
  Application.View.extend({
    ...
    template: "",
    reload: function() {
      return this.$el[0].contentWindow.location.reload();
    },
    navigate: function(url, options) {
      return this.$el[0].contentWindow.Backbone.history.navigate(url, options);
    }
  });
