(function(){
  ...
  View.registerHelper('layout', function(options) {
    ...
    return new Handlebars.SafeString(View.tag.call(this, options.hash));
  });
  ...
  var Layout = View.extend({
    ...
    events: {
      rendered: function() {
        ...
        getLayoutViewsTargetElement.call(this).length || this.$el.attr(layout_cid_attribute_name, this.cid);
      }
    },
    _ensureElement : function() {
      Backbone.View.prototype._ensureElement.call(this);
